package com.example.noteappfromcourse.dataStore
...
const val DATE_STORE_NAME = "preference_storage_name"
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(DATE_STORE_NAME)
